...
export default function ChefCTA() {
  ...
  const handleSubmit = async (e) => {
    ...
    setWaLink(`https://wa.me/50377947885?text=${waMsg}`);
            ...
            {submitted ? (
              <div className="py-16 text-center space-y-6">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#25D366]/10 border border-[#25D366]/40 hover:bg-[#25D366]/20 text-[#25D366] font-body text-[11px] tracking-[0.2em] uppercase font-bold px-6 py-3 rounded-full transition-all duration-300"
                >
